...
def reset_timer():
    ...
    timer_headline.config(text= "Timer")
...
# Timer headline
timer_headline = Label(text="Timer", font=(FONT_NAME, 50), fg=GREEN, bg=YELLOW, highlightthickness=0)
timer_headline.grid(column=1, row=0)
